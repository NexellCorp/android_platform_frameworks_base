...
public final class SystemServer {
    ...
    private void startBootstrapServices() {
        ...
        // psw0523 fix : AVN not use vold.decrypt
        mOnlyCore = false;
    ...
    // psw0523 add
    private void startUICoreServices() {
        ...
        try {
            if (mountService != null) mountService.systemReady();
        } catch (Throwable e) {
